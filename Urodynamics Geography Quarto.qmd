...
#Remove any non-census tract header rows if present
#(The original CMS download had 2 metadata rows; API download may not)
ct_data <- ct_data[grepl("^1400000US", GEO_ID)]
